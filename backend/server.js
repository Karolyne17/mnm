...
app.get("/bdd", async (req, res) => {
  ...
  await db.sequelize.query(
    "INSERT INTO travels (id, latStart, longStart, cityStart, dateStart, latArrival, longArrival, cityArrival, smoker, airconditionning, createdAt, updatedAt, deletedAt, driver_id, car_id) VALUES (NULL, 49.12050593176526, 6.176398302969596, 'Metz', '2022-08-31 15:53:29', 49.10690889776032, 6.17669532660292, 'MNS', 1, 0, '2022-08-29 13:53:29', '2022-08-29 13:53:29', '2022-08-29 13:53:29', 1, 1),(NULL, 49.10690889776032, 6.17669532660292, 'MNS', '2022-08-30 15:53:29', 49.09692311238716, 6.142755324063217, 'Montigny-les-metz', 0, 0, '2022-08-29 13:53:29', '2022-08-29 13:53:29', '2022-08-29 13:53:29', 2, 2);"
  );
  await db.sequelize.query(
